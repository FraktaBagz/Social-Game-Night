  ...
  return (
    <Box>
      <Card sx={{ p: 2.5, borderRadius: 9, width: 325, display: 'inline-flex', }}>
        ...
        <Avatar
<<<<<<< HEAD
          src={user.avatar ? user.avatar : 'https://www.kindpng.com/picc/m/289-2891537_nintendo-fanon-wiki-wii-mii-hd-png-download.png'}
=======
          src={user ? user.avatar : null}
>>>>>>> 850067954912e83364772f07d00fda6bb60ed768
          sx={{ width: 56, height: 56 }}
        />
        <Box sx={{ width: '100%' }}>
          <Box component={Stack} direction="column" justifyContent="center" sx={{ pl: 2 }}>
...
<<<<<<< HEAD
            ...
            <Typography variant='subtitle1'>
              <i>{user.title ? user.title : 'The Neophyte'}</i>
=======
              {user ? user.name : null}
            </Typography>
            <Typography variant='subtitle1'>
